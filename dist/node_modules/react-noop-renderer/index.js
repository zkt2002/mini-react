(function (global, factory) {
	...
	(global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global.index = global.index || {}, global.index.js = {}), global.React, global.Scheduler));
	...
	const SyncLane = /*             */ 0b0000000000000000000000000000001; // 同步，ex：onClick
	...
	function markRootFinished(root, lanes) {
	...
	function ChildReconclier(shouldTrackEffects) {
	    ...
	    /** 处理多节点的情况，包含diff算法 */
	    function reconclieChildrenArray(returnFiber, currentFirstChild, 
	...
	function updateFragment$1(returnFiber, current, 
	// eslint-disable-next-line @typescript-eslint/no-explicit-any
	elements, key, existingChildren) {
	    let fiber;
	...
	/** 对于effecthook，passive代表 useEffect对应effect */
	const Passive = 0b0010;
	/** 对于effecthook，hookHasEffect代表 当前useEffect本次更新存在副作用 */
	...
	function updateEffect(create, deps) {
	    ...
	    // 浅比较不相等,会执行effect副作用
	    currentlyRenderingFiber.flags |= PassiveEffect;
	    hook.memorizedState = pushEffect(Passive | HookHasEffect, create, 
	    // @ts-ignore
	    destroy, nextDeps);
	}
